...
<main role="main">
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <c:forEach items="${list}" var="toutiao">
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img class="bd-placeholder-img card-img-top" width="100%" height="225" src="/pic/${toutiao.image}"></img>

                        <div class="card-body">
                            <p class="card-text">${toutiao.title}</p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">${toutiao.time} </small>
                            </div>
                        </div>
                    </div>
                </div>
